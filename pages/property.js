...
const defaultOrder = [
  {
    key: '1',
    label: (
      <a onClick={(e) => e.preventDefault()}>Latest</a>
    )
  },
  {
    key: '2',
    label: (
      <a onClick={(e) => e.preventDefault()}>Popular</a>
    )
  },
  {
    key: '3',
    label: (
      <a onClick={(e) => e.preventDefault()}>Recommended</a>
    )
  }
];
...
const PropertiesGridView = () => {
  ...
  return (
    <div className="bg-gray-white w-full flex flex-col items-start justify-start text-center text-33xl text-gray-white font-body-regular-400">
      ...
      <div className="h-60 self-stretch flex flex-col items-center justify-center bg-[url(/category@3x.png)] bg-cover bg-no-repeat bg-top">
