      ...
      <div className="flex-1 flex flex-row items-center justify-between">
        <Link href='/' className="flex flex-row items-center justify-center gap-[8px]">
          ...
          <div className="flex flex-col items-start justify-start">
            <div className="relative leading-[24px] font-semibold">A</div>
        ...
        <div className="flex flex-row items-center justify-end gap-[36px] text-sm text-primary-900 sm:flex">
          <div className="flex flex-row items-start justify-start gap-[30px] lg:hidden">
            <Link href='/' className="relative leading-[22px]">HOME</Link>
            <Link href='/' className="relative leading-[22px]">ABOUT US</Link>
            <Link href='/' className="relative leading-[22px]">OUR AGENTS</Link>
            <Link href='/property' className="relative leading-[22px] font-semibold">
              PROPERTIES
            </Link>
            <Link href='/' className="relative leading-[22px]">GALLERY</Link>
            <Link href='/' className="relative leading-[22px]">BLOG</Link>
            <Link href='/' className="relative leading-[22px]">CONTACT US</Link>
            <Link href='/' className="relative leading-[22px]">SEARCH</Link>
          </div>
          {!hamburger && (
